const local: App.I18n.Schema = {
  ...
  route: {
    ...
    home: '首页',
    sports: '运动会管理',
    sports_announcements: '公告管理',
    sports_awards: '奖项管理',
    sports_departments: '院系管理',
    sports_events: '赛事管理',
    sports_items: '项目管理',
    sports_registrations: '报名管理',
    sports_results: '成绩管理',
    sports_schedules: '赛程管理',
    sports_users: '用户管理'
  },
  page: {
    login: {
    ...
    home: {
      branchDesc: '',
      greeting: '你好，{userName}，欢迎回到运动会管理后台！',
      weatherDesc: '让我们一起管理好每一场赛事',
      projectCount: '用户总数',
      todo: '待审报名',
      message: '进行中赛事',
      downloadCount: '运动项目',
